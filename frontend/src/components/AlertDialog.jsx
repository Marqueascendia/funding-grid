          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex justify-end gap-4 sm:px-6">
              ...
              <button
                ...
                className="mt-3 inline-flex justify-center items-center w-[90px] bg-violet-600 rounded-md px-3 py-2 text-sm font-semibold text-white ring-1 shadow-xs hover:bg-violet-500 sm:mt-0 sm:w-auto"
              >
